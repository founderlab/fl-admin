...
var _componentsInputsSmart = require('../components/inputs/smart');

var _componentsInputsSmart2 = _interopRequireDefault(_componentsInputsSmart);
...
function mapFieldsToInputs(model_admin, fields) {
  ...
  var InputComponent = arguments.length <= 3 || arguments[3] === undefined ? _componentsInputsSmart2['default'] : arguments[3];
  ...
  return _lodash2['default'].map(fields, function (field, key) {
    ...
    (0, _warning2['default'])(model_field, '[fl-admin] Can\'t find model_field for key ' + key + ': is this key the field name instead of the virtual_id_accessor?');
