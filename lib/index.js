...
function createModelAdmin(options, model_descriptor) {
  ...
  model_admin.actions = actions[model_admin.path] = _create_actions2['default'](model_admin);
  model_admin.reducer = reducers[model_admin.path] = _create_reducer2['default'](model_admin);
  ...
  if (!model_admin.components.Pagination) model_admin.components.Pagination = _containersGeneratorsPagination2['default'](model_admin);
