  ...
  _createClass(FieldInput, [{
    ...
    value: function render() {
      ...
      if (model_field.model_admin) {
        var RelatedSelector = (0, _containersGeneratorsRelated_field2['default'])(model_field);
        return _react2['default'].createElement(RelatedSelector, { form_field: form_field });
      }
