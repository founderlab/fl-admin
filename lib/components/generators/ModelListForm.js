...
var ModelListForm = (function (_React$Component) {
  ...
  ModelListForm.prototype.render = function render() {
    ...
    var inputs = _lib.mapFieldsToInputs(model_admin, fields, { model: model, config: config, handleSubmit: handleSubmit, size: 'small' });
    ...
    return _react2['default'].createElement(
      ...
      model_admin.list_delete && _react2['default'].createElement(
        'td',
