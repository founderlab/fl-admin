...
var FileUploader = (function (_React$Component) {
  ...
  FileUploader.prototype.render = function render() {
    ...
    var uploader_props = { style: style, max_file_size: max_file_size, s3_url: s3_url, filename: filename, host: url };
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(_reactDropzoneS3Uploader.DropzoneS3Uploader, _extends({ onFinish: this.handleFinishedUpload }, uploader_props))
    );
  };
