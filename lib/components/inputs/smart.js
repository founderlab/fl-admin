...
function SmartInput(props) {
  ...
  if (model_field.model_admin) {
    var RelatedField = (0, _containersGeneratorsRelated_field2['default'])(model_field, model);
    return _react2['default'].createElement(RelatedField, { input_props: input_props });
  }
