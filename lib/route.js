...
var _containersGeneratorsModel_editor = require('./containers/generators/model_editor');

var _containersGeneratorsModel_editor2 = _interopRequireDefault(_containersGeneratorsModel_editor);
      ...
      if (!this.child_routes) {
        ...
        _index.model_admins.forEach(function (model_admin) {
          _this.child_routes.push(model_admin.list_route || {
            ...
            component: model_admin.list_component || (0, _containersGeneratorsModel_editor2['default'])(model_admin)
          });
          _this.child_routes.push(model_admin.detail_route || {
            path: model_admin.path + '/:id',
            component: model_admin.detail_component || (0, _containersGeneratorsModel_editor2['default'])(model_admin)
          });
        });
      }
