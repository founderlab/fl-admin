...
function createRelatedField(relation) {
  var model_admin = relation.model_admin;
  ...
  return (function (_Component) {
    ...
    _createClass(RelatedField, [{
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(_componentsRelated_model_selector2['default'], { relation: relation, model_admin: model_admin, model_store: model_store, form_field: form_field });
      }
    }], [{
      key: 'propTypes',
      value: {
